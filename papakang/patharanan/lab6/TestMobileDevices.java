/**TestMobileDevices class running objects from class IPadAir and class AppleWatch
 * Creating a new comparePrice object
...
public class TestMobileDevices {
  ...
  private static void comparePrice(MobileDevice obj1, MobileDevice obj2) {
    if (obj1.getPrice() < obj2.getPrice()) {
      System.out.println(obj1 + " is cheaper than " + obj2);
    } else if (obj1.getPrice() > obj2.getPrice()) {
      System.out.println(obj2 + " is cheaper than " + obj1);
    } else {
