...
public class MobileDeviceFromV1 extends MySimpleWindow {
  ...
  public MobileDeviceFromV1(String titel) {
    super(titel);
  }
  ...
  public static void createAndShowGUI() {
    MobileDeviceFromV1 msw = new MobileDeviceFromV1("Mobile Device From V1");
    msw.addComponents();
